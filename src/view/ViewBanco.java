...
public class ViewBanco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Bancos Cadastradas"));
        ...
        tbBanco.getColumnModel().getColumn(1).setPreferredWidth(250);
    ...
    private void criaTabela() {
        tbBanco.setModel(modelo);
        tbBanco.getColumnModel().getColumn(1).setPreferredWidth(400);
    }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        int linha = tbBanco.getSelectedRow();
        ativo = false;
        ...
        if (linha == -1) {
            ...
            cod = Integer.parseInt(String.valueOf(tbBanco.getValueAt(linha, 0)));
            String nome = String.valueOf(tbBanco.getValueAt(linha, 1));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (linha == -1) {
            ...
            if (resp == 0) {
                ...
                int codigo = Integer.parseInt(String.valueOf(tbBanco.getValueAt(linha, 0)));
